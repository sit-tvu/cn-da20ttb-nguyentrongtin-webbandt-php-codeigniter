        ...
        <div class="content-wrapper" style="min-height: 639px;">
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/KhachHangController" role="button">
                    ...
                    <div class="col-md-12">
                        <div class="box" id="view">
                            <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4" style="padding-left: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input type="number" readonly class="form-control" name="makh" style="width:100%" value="<?php echo $arrResult[0]['MaKH'] ?>" min="0" step="1">
                                            </div>
                                        </div>
                                        <div class="col-md-8" style="padding-right: 0px;">
                                            <div class="form-group">
                                                <label>Tên khách hàng</label>
                                                <input type="text" readonly class="form-control" name="tenkh" style="width:100%" placeholder="Tên khách hàng" value="<?php echo $arrResult[0]['TenKH'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-5" style="padding-left: 0px;">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly class="form-control" name="sdt" style="width:100%" placeholder="SĐT khách hàng" value="<?php echo $arrResult[0]['SDT'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-7" style="padding-right: 0px;">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" readonly class="form-control" name="email" style="width:100%" placeholder="Email khách hàng" value="<?php echo $arrResult[0]['Email'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="col-md-4" style="padding-left: 0px;">
                                            <div class="form-group">
                                                ...
                                                <select name="gtkhIP" class="form-group" style="width:100%;padding: 7px;" disabled>
                                                    <option value="<?php echo $arrResult[0]['GioiTinh'] ?>" selected>
                                                        <?php echo $arrResult[0]['GioiTinh'] ?>
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                <label>CMND</label>
                                                <input type="text" readonly class="form-control" name="cmnd" style="width:100%" placeholder="CMND khách hàng" value="<?php echo $arrResult[0]['CMND'] ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-4" style="padding-right: 0px;">
                                            <div class="form-group">
                                                ...
                                                <select name="gtkhIP" class="form-group" style="width:100%; padding: 7px;" disabled>
                                                    <option value="<?php echo $arrResult[0]['LoaiKH'] ?>" selected>
                                                        <?php echo $arrResult[0]['LoaiKH'] ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="form-group">
                                    <label>Địa chỉ</label>
                                    <input type="text" readonly class="form-control" name="diachi" style="width:100%" placeholder="Địa Chỉ khách hàng" value="<?php echo $arrResult[0]['DiaChi'] ?>">
                                </div>
                            </div>
                        </div>
