        ...
        <div class="content-wrapper" style="min-height: 639px;">
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    ...
                    <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/ThemKMController" role="button">
                                                    ...
                                                    <?php foreach ($arrResult as $item) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a class="btn btn-success btn-xs" href="<?php echo base_url() ?>index.php/SuaKMController/?makm=<?php echo $item['MaKM'] ?>" role="button">
                                                                    <span class="glyphicon glyphicon-edit"></span>Sửa
                                                                </a>
                                                            </td>
                                                            <td class="text-center">
                                                                <a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>index.php/KhuyenMaiController/XoaKM?makm=<?php echo $item['MaKM'] ?>" onclick="return confirm('Xác nhận xóa khuyến mãi này ?')" role="button">
