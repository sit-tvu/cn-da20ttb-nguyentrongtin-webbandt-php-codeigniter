...
<body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        <form method="post" enctype="multipart/form-data" action="<?php echo base_url(); ?>index.php/ThemMoiTTSPController/ThemTTSP">
            ...
            <div class="content-wrapper" style="min-height: 639px;">
                <section class="content-header">
                    <h1>
                        <i class="glyphicon glyphicon-phone"></i>Thêm thông tin sản phẩm mới
                    </h1>
                    <div class="breadcrumb">
                        <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/SanPhamController" role="button">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="masp" id="" class="form-control">
                                                    <?php foreach ($arrResult as $item) : ?>
                                                        <option value="<?php echo $item['masp'] ?>">
                                                            <?php echo $item['tensp'] ?></option>
                                                    <?php endforeach ?>
                                                </select>
                                            </div>
                                            <div class="row">
                                                ...
                                                <div class="col-md-12" style="border-top:ridge; padding-top: 10px;">
                                                    <div class="col-md-6" style="padding-left: 0px;">
                                                        <div class="form-group">
                                                            <label>Giá</label>
                                                            <input name="gia" class="form-control" type="number" value="0" min="0">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6" style="padding-right: 0px;">
                                                        <div class="form-group">
                                                            <Label>Giá khuyến mãi</Label>
                                                            <input name="giakm" class="form-control" type="number" value="0" min="0">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="col-md-6" style="padding-right: 0px;">
                                                        ...
                                                        <input name="soluong" class="form-control" type="number" value="0" min="0" step="1">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-6" style="padding-left: 0px;">
                                                        <div class="form-group">
                                                            <label>Ram</label>
                                                            <input name="ram" class="form-control" type="number" value="0" min="0" max="256" step="1">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6" style="padding-right: 0px;">
                                                        <div class="form-group">
                                                            <label>Bộ nhớ trong</label>
                                                            <input name="rom" class="form-control" type="number" value="0" min="0" max="1028" step="1">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-6" style="padding-left: 0px;">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="pin" class="form-control" type="number" value="0" min="0" max="100000" step="1">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6" style="padding-right: 0px;">
                                                        <div class="form-group">
                                                            <label>Kích thước màn hình</label>
                                                            <input name="kichthuocmh" class="form-control" type="number" value="0" min="0" max="100" step="0.1">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-6" style="padding-left: 0px;">
                                                        <div class="form-group">
                                                            ...
                                                            <input name="camtruoc" class="form-control" type="text" placeholder="Camera trước">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6" style="padding-right: 0px;">
                                                        <div class="form-group">
                                                            <label>Camera sau</label>
                                                            <input name="camsau" class="form-control" type="text" placeholder="Camera sau">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="col-md-6" style="padding-left: 0px;">
                                                        <div class="form-group">
                                                            <label>Màu sắc</label>
                                                            <input name="mausac" class="form-control" type="text" placeholder="Màu sắc">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6" style="padding-right: 0px;">
                                                        <div class="form-group">
