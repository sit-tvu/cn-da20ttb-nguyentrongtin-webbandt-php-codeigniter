                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="fa fa-chart-bar"> Top 3 khách hàng mua hàng nhiều nhất</h3>
                            </div>
                            <div class="box-footer">
                                <div class="col-sm-4 col-xs-6">
                                    <div class="description-block border-right" style="display: inline-flex;">
                                        <span class="description-text">Top 1 :
                                            <?php echo $KHMuaNhieu[0]['tenkh'] ?></span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $KHMuaNhieu[0]['total'] ?> VNĐ
                                        </h5>
                                ...
                                <div class="col-sm-4 col-xs-6">
                                    <div class="description-block border-right" style="display: inline-flex;">
                                        <span class="description-text">Top 2 :
                                            <?php echo $KHMuaNhieu[1]['tenkh'] ?></span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $KHMuaNhieu[1]['total'] ?> VNĐ
                                        </h5>
                                ...
                                <div class="description-block border-right" style="display: inline-flex;">
                                    <span class="description-text">Top 3 :
                                        <?php echo $KHMuaNhieu[2]['tenkh'] ?></span>
                                    <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                        <?php echo $KHMuaNhieu[2]['total'] ?> VNĐ
                                    </h5>
