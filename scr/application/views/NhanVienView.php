        ...
        <div class="content-wrapper" style="min-height: 639px;">
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    ...
                    <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/ThemNVController" role="button">
                                                    ...
                                                    <?php foreach ($arrResult as $item) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a class="btn btn-success btn-xs" href="<?php echo base_url() ?>index.php/SuaNVController/?manv=<?php echo $item['MaNV'] ?>" role="button">
                                                                    <span class="glyphicon glyphicon-edit"></span>Sửa
                                                                </a>
                                                            </td>
                                                            <td class="text-center">
                                                                <a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>index.php/NhanVienController/XoaNV/?manv=<?php echo $item['MaNV'] ?>" onclick="return confirm('Xác nhận xóa nhân viên này ?')" role="button">
