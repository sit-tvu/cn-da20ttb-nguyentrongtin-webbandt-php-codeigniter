        ...
        <div class="content-wrapper" style="min-height: 639px;">
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    ...
                    <a class="btn btn-primary btn-sm" href="<?php echo base_url(); ?>index.php/ThemPNController" role="button">
                                                ...
                                                <tbody>
                                                    <?php foreach ($arrResult as $item) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a class="btn btn-info btn-xs" href="<?php echo base_url() ?>index.php/CTPNController/?mapn=<?php echo $item['MaPN'] ?>" role="button">
                                                                    <span class="glyphicon glyphicon-eye-open"></span>Xem
                                                                </a>
                                                            </td>
                                                            <td class="text-center">
                                                                <a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>index.php/NhapHangController/XoaPN/?mapn=<?php echo $item['MaPN'] ?>&tttt=<?php echo $item['TinhTrangTT'] ?>" onclick="return confirm('Xác nhận xóa phiếu này ?')" role="button">
