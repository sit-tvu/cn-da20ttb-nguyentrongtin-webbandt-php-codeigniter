            ...
            <section class="content-header">
                ...
                <div class="breadcrumb">
                    ...
                    <a class="btn btn-primary btn-sm" style="margin-left: 20px;"
                        href="<?php echo base_url() ?>index.php/ThemMoiTTSPController" role="button">
                        <span class="glyphicon glyphicon-plus"></span>Thêm mới TTSP
                    </a>
                </div>
            </section>
                                    ...
                                    <div class="row" style="padding:0px; margin:0px; height: 1000px;">
                                        <div class="table-responsive">
                                            <table class="table table-hover table-bordered">
                                                <thead>
                                                    <tr>
                                                        <th class="text-center" style="width:70px">MaSP</th>
                                                        <th class="text-center" style="width:90px">MaTTSP</th>
                                                        <th>Tên sản phẩm</th>
                                                        <th>Hình ảnh</th>
                                                        <th>Số lượng</th>
                                                        <th>Loại sản phẩm</th>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?php echo $item['mattsp'] ?></td>
