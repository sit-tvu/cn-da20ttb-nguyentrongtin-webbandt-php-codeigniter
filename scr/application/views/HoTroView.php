                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-center"><?php echo $item['MaBL']?></td>
                                                    <td><?php echo $item['tensp']?> - <?php echo $item['mausac']?> -
                                                        <?php echo $item['ram']?> GB</td>
                                                    <td><?php echo $item['TenKH']?></td>
                                                    <td><?php echo $item['NoiDung']?></td>
                                                    <td class="text-center">
                                                        <a class="btn btn-danger btn-xs"
                                                            href="<?php echo base_url(); ?>index.php/HoTroController/XoaBL/?mabl=<?php echo $item['MaBL']?>"
