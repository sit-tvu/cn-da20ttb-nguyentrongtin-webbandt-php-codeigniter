                ...
                <div class="row">
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-aqua">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/ThongKeController/SPBanChay" class="small-box-footer">Thống kê top 5 sản phẩm bán chạy</a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-green">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/HoaDonController/" class="small-box-footer">Thống kê số lần bán</a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-yellow">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/ThongKeController/KHMuaNhieu" class="small-box-footer">Thống kê khách hàng mua nhiều nhất</a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-red">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/NhaCungCapController/" class="small-box-footer">Thống kê nhà cung cấp</a>
                        </div>
                    </div>
                    <!-- ./col -->
                </div>
                        ...
                        <div class="box box-info">
                            <div class="box-header with-border">
                                ...
                                <div class="bread_crumb">
                                    <form action="<?php echo base_url() ?>index.php/ThongKeController/DoanhThu" method="post">
                                    ...
                                    <div class="col-sm-4 col-xs-6">
                                        <div class="description-block border-right">
                                            ...
                                            <h5 class="description-header" style="color: #e90000;">
                                                <?php echo $tongdoanhthu[0]['total'] ?> VNĐ</h5>
                                        </div>
                                        <!-- /.description-block -->
                                    </div>
                                    <!-- /.col -->
