...
<body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <form class="content-wrapper" style="min-height: 639px;" action="<?php echo base_url() ?>index.php/ThemTinTucController/ThemTinTuc" method="post" enctype="multipart/form-data">
                            ...
                            <div class="box-body">
                                <div class="col-md-8">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="tieude" style="width:100%" placeholder="Tên bài viết" value="">
                                    </div>
                                    <div class="form-group">
                                        <label>Mô tả</label>
                                        <textarea name="mota" class="form-control" style="height: 8vh;"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label>Nội dung</label>
                                        <textarea name="noidung" class="form-control" style="height: 50vh;"></textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Hình đại diện</label>
                                        <input type="file" id="image_list" name="hinhanh" style="width: 100%" required>
                                    </div>
                                </div>
                            </div>
                        </div>
