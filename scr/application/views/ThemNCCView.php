...
<body class="skin-blue sidebar-mini">
    ...
    <div class="wrapper">
        ...
        <form class="content-wrapper" style="min-height: 639px;" action="<?php echo base_url() ?>index.php/ThemNCCController/ThemNCC" method="post">
                    ...
                    <div class="col-md-12">
                        <div class="box" id="view">
                            <div class="box-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="col-md-6" style="padding-left: 0px;">
                                            <div class="form-group">
                                                <label>Email</label>
                                                <input type="text" class="form-control" name="emailncc" style="width:100%" placeholder="Email nhà cung cấp">
                                            </div>
                                        </div>
                                        <div class="col-md-6" style="padding-right: 0px;">
                                            <div class="form-group">
                                                <label>Số điện thoại</label>
                                                <input type="text" class="form-control" name="sdtncc" style="width:100%" placeholder="SĐT nhà cung cấp">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label>Địa chỉ</label>
                                    <input type="text" class="form-control" name="dcncc" style="width:100%" placeholder="Địa Chỉ nhà cung cấp">
                                </div>
                                <div class="form-group">
                                    <label>Website</label>
                                    <input type="text" class="form-control" name="wsncc" style="width:100%" placeholder="Website nhà cung cấp">
                                </div>
                            </div>
                        </div>
                    </div>
