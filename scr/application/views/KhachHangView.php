                                                    ...
                                                    <?php foreach ($arrResult as $item) : ?>
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                <a class="btn btn-info btn-xs" href="<?php echo base_url() ?>index.php/XemKHController/?makh=<?php echo $item['MaKH'] ?>" role="button">
                                                                    <span class="glyphicon glyphicon-eye-open"></span>Xem
                                                                </a>
                                                            </td>
                                                            <td class="text-center">
                                                                <a class="btn btn-danger btn-xs" href="<?php echo base_url() ?>index.php/KhachHangController/XoaKH/?makh=<?php echo $item['MaKH'] ?>" onclick="return confirm('Xác nhận xóa khách hàng này ?')" role="button">
