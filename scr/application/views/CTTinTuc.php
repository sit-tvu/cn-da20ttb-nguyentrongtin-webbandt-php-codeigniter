...
<body>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="product-bit-title text-center">
                        <h2><?php echo $arrResult[0]['tieude'] ?></h2>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="single-product-area">
        ...
        <div class="container">
            <p class="text-center" style="margin-bottom: 30px;"><img src="<?php echo $arrResult[0]['hinhanh'] ?>"
                    alt=""></p>
            <p><?php echo $arrResult[0]['noidung'] ?></p>
            <b>
                <p class="text-right">Tác giả: <?php echo $arrResult[0]['nguoidang'] ?></p>
            </b>
            <b>
                <p class="text-right">Xuất bản: <?php echo $arrResult[0]['ngaydang'] ?></p>
            </b>
        </div>
    </div>
