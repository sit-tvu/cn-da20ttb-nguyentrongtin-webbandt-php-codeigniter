                    ...
                    <div class="col-lg-3 col-xs-6">
                        ...
                        <div class="small-box bg-yellow">
                            ...
                            <a href="<?php echo base_url(); ?>index.php/ThongKeController/KHMuaNhieu"
                                class="small-box-footer">Thống kê khách hàng mua nhiều nhất</a>
                        </div>
                    </div>
                    <!-- ./col -->
                    <div class="col-lg-3 col-xs-6">
                    ...
                    <div class="col-md-12">
                        <div class="box box-info">
                            <div class="box-header with-border">
                                <h3 class="fa fa-chart-bar"> Top 5 sản phẩm bán chạy nhất</h3>
                            </div>
                            <div class="box-footer">
                                <div class="col-sm-6 col-xs-6">
                                    <div class="description-block border-right" style="display: inline-flex;">
                                        <span class="description-text"><b>Top 1</b> : </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[0]['tensp'] ?> - <?php echo $SPBanChay[0]['mausac'] ?>
                                            - <?php echo $SPBanChay[0]['ram'] ?> GB
                                        </h5>
                                        <span class="description-text" style="margin-left: 20px;">Số lượng đã bán:
                                        </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[0]['total'] ?>
                                        </h5>
                                        <a class="btn btn-primary btn-sm"
                                            href="<?php echo base_url(); ?>index.php/CTSPController/?masp=<?php echo $SPBanChay[0]['masp'] ?>&mattsp=<?php echo $SPBanChay[0]['mattsp'] ?>"
                                            role="button" style="margin-left: 20px;">Xem</a>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="description-block border-right" style="display: inline-flex;">
                                        <span class="description-text"><b>Top 2</b> : </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[1]['tensp'] ?> - <?php echo $SPBanChay[1]['mausac'] ?>
                                            - <?php echo $SPBanChay[1]['ram'] ?> GB
                                        </h5>
                                        <span class="description-text" style="margin-left: 20px;">Số lượng đã bán:
                                        </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[1]['total'] ?>
                                        </h5>
                                        <a class="btn btn-primary btn-sm"
                                            href="<?php echo base_url(); ?>index.php/CTSPController/?masp=<?php echo $SPBanChay[1]['masp'] ?>&mattsp=<?php echo $SPBanChay[1]['mattsp'] ?>"
                                            role="button" style="margin-left: 20px;">Xem</a>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="description-block border-right" style="display: inline-flex;">
                                        <span class="description-text"><b>Top 3</b> : </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[2]['tensp'] ?> - <?php echo $SPBanChay[2]['mausac'] ?>
                                            - <?php echo $SPBanChay[2]['ram'] ?> GB
                                        </h5>
                                        <span class="description-text" style="margin-left: 20px;">Số lượng đã bán:
                                        </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[2]['total'] ?>
                                        </h5>
                                        <a class="btn btn-primary btn-sm"
                                            href="<?php echo base_url(); ?>index.php/CTSPController/?masp=<?php echo $SPBanChay[2]['masp'] ?>&mattsp=<?php echo $SPBanChay[2]['mattsp'] ?>"
                                            role="button" style="margin-left: 20px;">Xem</a>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="description-block border-right" style="display: inline-flex;">
                                        <span class="description-text"><b>Top 4</b> : </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[3]['tensp'] ?> - <?php echo $SPBanChay[3]['mausac'] ?>
                                            - <?php echo $SPBanChay[3]['ram'] ?> GB
                                        </h5>
                                        <span class="description-text" style="margin-left: 20px;">Số lượng đã bán:
                                        </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[3]['total'] ?>
                                        </h5>
                                        <a class="btn btn-primary btn-sm"
                                            href="<?php echo base_url(); ?>index.php/CTSPController/?masp=<?php echo $SPBanChay[3]['masp'] ?>&mattsp=<?php echo $SPBanChay[3]['mattsp'] ?>"
                                            role="button" style="margin-left: 20px;">Xem</a>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
                                <div class="col-sm-6 col-xs-6">
                                    <div class="description-block border-right" style="display: inline-flex;">
                                        <span class="description-text"><b>Top 5</b> : </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[4]['tensp'] ?> - <?php echo $SPBanChay[4]['mausac'] ?>
                                            - <?php echo $SPBanChay[4]['ram'] ?> GB
                                        </h5>
                                        <span class="description-text" style="margin-left: 20px;">Số lượng đã bán:
                                        </span>
                                        <h5 class="description-header" style="color: #e90000;padding-left: 10px;">
                                            <?php echo $SPBanChay[4]['total'] ?>
                                        </h5>
                                        <a class="btn btn-primary btn-sm"
                                            href="<?php echo base_url(); ?>index.php/CTSPController/?masp=<?php echo $SPBanChay[4]['masp'] ?>&mattsp=<?php echo $SPBanChay[4]['mattsp'] ?>"
                                            role="button" style="margin-left: 20px;">Xem</a>
                                    </div>
                                    <!-- /.description-block -->
                                </div>
