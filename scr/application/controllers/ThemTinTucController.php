<?php 
	...
	class ThemTinTucController extends CI_Controller {
		...
		public function ThemTinTuc()
		{
			...
			{
				$this->TinTucModel->ThemTinTuc($noidung, $tieude, $mota, $hinhanh, $nguoidang, $ngaydang);
				header("Location:". base_url() . "index.php/TinTucController");
			}
			else
			{
				echo "Hãy tải hình ảnh lên";
			}
		}
	
	}
	
	/* End of file ThemTinTucController.php */
